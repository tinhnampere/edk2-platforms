...
typedef BOOLEAN (PCI_CHECK_ROOT_BRIDGE_DISABLED_FUNC)(
  IN UINTN,
  IN UINTN
  );
...
typedef EFI_STATUS (PCI_CORE_SETUP_FUNC)(
  EFI_HANDLE,
  EFI_SYSTEM_TABLE *
  );
...
typedef EFI_STATUS (PCI_CORE_SETUP_ROOT_BRIDGE_FUNC)(
  IN UINTN,
  IN UINTN,
  IN PCI_ROOT_BRIDGE *
  );
...
typedef EFI_STATUS (PCI_CORE_IO_PCI_RW_FUNC)(
  IN     VOID *,
  IN     UINT64,
  IN     BOOLEAN,
  IN     UINTN,
...
typedef VOID (PCI_CORE_HOST_BRIDGE_NOTIFY_PHASE_FUNC)(
  IN UINTN,
  IN UINTN,
