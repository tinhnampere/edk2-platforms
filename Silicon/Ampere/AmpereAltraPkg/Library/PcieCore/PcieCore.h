...
#define AC01_HOST_BRIDGE_DEVICEID       0xE00D
#define AC01_PCIE_BRIDGE_DEVICEID       0xE00E
...
INT32
Ac01PcieCfgOut32 (VOID *Addr, UINT32 Val);

INT32
Ac01PcieCfgOut16 (VOID *Addr, UINT16 Val);

INT32
Ac01PcieCfgOut8 (VOID *Addr, UINT8 Val);

INT32
Ac01PcieCfgIn32 (VOID *Addr, UINT32 *Val);

INT32
Ac01PcieCfgIn16 (VOID *Addr, UINT16 *Val);

INT32
Ac01PcieCfgIn8 (VOID *Addr, UINT8 *Val);

INT32
Ac01PcieCoreSetup (AC01_RC *RC);

VOID
Ac01PcieCoreResetPort (AC01_RC *RC);

VOID
Ac01PcieClearConfigPort (AC01_RC *RC);
